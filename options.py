...
def args_parser():
    ...
    parser.add_argument('--root_path', type=str, default='data/r4/mix',
                        help='dataset root dir')
    parser.add_argument('--csv_file_train', type=str, default='data/r4/train.csv',
    ...
    parser.add_argument('--csv_file_test', type=str, default='data/r4/test.csv', help='testing set csv file')
